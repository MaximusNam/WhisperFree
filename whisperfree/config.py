...
# Поэтому не угадывайте — измерьте: calibrate.bat помолчит перед микрофоном и
# напечатает ваш уровень тишины вместе с готовой строкой для этого файла.
...
# flac вдвое меньше wav при той же точности, значит быстрее аплоад.
encode = "flac"
