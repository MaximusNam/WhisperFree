...
live requests, August 2026: transcription 204–336 ms, refinement 293–702 ms, an
...
The values are ISO 702-1 codes, passed straight through to the provider's
`language` parameter.
...
- **702 automated tests** pass, including an end-to-end run of the pipeline
...
Before a pull request it is worth running the tests, currently 702 of them.
